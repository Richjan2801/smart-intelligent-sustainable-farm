export const lang = {
  EN: {
    ...
    pumpDesc: "Manual override control for the irrigation pump.",
    deviceOffline: "Device is offline — pump control unavailable.",
    pumpFail: "Failed to trigger pump.",
    turnOn: "Turn ON",
    turnOff: "Turn OFF",
    pumpRunning: "Pump: ON",
    pumpStopped: "Pump: OFF",
    actions: "Actions",
    save: "Save",
    edit: "Edit",
    delete: "Delete",
  ...
  ID: {
    ...
    pumpDesc: "Kendali manual pompa penyiraman tanaman.",
    deviceOffline: "Perangkat offline — tidak dapat mengendalikan pompa.",
    pumpFail: "Gagal mengirim perintah pompa.",
    turnOn: "Nyalakan",
    turnOff: "Matikan",
    pumpRunning: "Pompa: NYALA",
    pumpStopped: "Pompa: MATI",
    actions: "Aksi",
    save: "Simpan",
    edit: "Ubah",
    delete: "Hapus",
